...
%     i=28;
   ...
   get_Hos(sample, suspect, annotation(i,1), annotation(i,2), fs1, fs2, i);

end
%   save ('C:\Projeto Final\Results\Gururani_evaluation_bigdataset\new_features.mat', 'costs', 'locs', 'slope_dev')
