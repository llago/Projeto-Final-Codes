...
feature_matrix(1,:) = min_cost/max(min_cost);
feature_matrix(2,:) = av_cost/max(av_cost);
feature_matrix(3,:) = std_cost/max(std_cost);

feature_matrix(4,:) = length_min_path/max(length_min_path);
feature_matrix(5,:) = av_length/max(av_length);
feature_matrix(6,:) = std_length/max(std_length);

feature_matrix(7,:) = slope_min/max(slope_min);
feature_matrix(8,:) = av_slope/max(av_slope);
feature_matrix(9,:) = std_slope/max(std_slope);

feature_matrix(10,:) = dev_min/max(dev_min);
feature_matrix(11,:) = av_dev/max(av_dev);
feature_matrix(12,:) = std_dev/max(std_dev);

feature_matrix(13,:) = diff_length_min/max(diff_length_min);
feature_matrix(14,:) = av_diff_length/max(av_diff_length);
feature_matrix(15,:) = std_diff_length/max(std_diff_length);
