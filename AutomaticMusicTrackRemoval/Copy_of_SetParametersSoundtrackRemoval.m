...
MUSICTRACK_FILE = '\Dataset\Gururani\Originals\01.mp3';
%MUSICTRACK_FILE = './AudioFiles/AvenidaBrasil/Faixa8.wav';
MIXTURE_FILE = '\Dataset\Gururani\Copied\01.mp3';
...
excerptWindowSize = 15;                             % size of the excerpt to be searched in the mixture file (in sec)
...
minLandmarkMatch  = 50;                             % the query has to have at least "minMatchTresh" number of landmarks matched with the mixture in the 
